...
<script type="text/babel">
    ...
    export default class Permissions extends Vue {
        ...
        headers = [
            ...
            {text: 'View', value: 'view',align: 'right', sortable: false},
            {text: 'Create', value: 'create',align: 'right', sortable: false},
            {text: 'Update', value: 'update',align: 'right', sortable: false},
            {text: 'Delete', value: 'delete',align: 'right', sortable: false}
        ];
        ...
        mounted() {
            ...
            this.$http.get('admin/permissions')
                ...
                .then(response => this.$http.get('admin/roles/' + this.$route.params.id)
                    .then(response => {
        ...
        save() {
            this.$http.post('admin/roles/' + this.$route.params.id + '/permissions', this.user_permissions)
                .then(res => {
